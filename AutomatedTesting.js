...
//$("#createNewEhrFromSubjectId").click(function(){
  var urlString1 = openEhrApi.concat('/rest/v1/ehr?subjectId=', subjectId, '&subjectNamespace=' ,subjectNamespace, '&commiterName=', committerName);
  var settings2 = {
      type: 'POST',
      url: urlString1,
      crossDomain: true,   
...
//$("#getEhrStatusFromSubjectId").click(function(){
    var urlString2 = openEhrApi.concat('/rest/v1/ehr/?subjectId=', subjectId, '&subjectNamespace=', subjectNamespace);
...
//$("#ProblemsUploadTemplate").click(function(){
    var urlTemplate1 = openEhrApi.concat('/rest/v1/template/');
    var settings4 = {
      "async": false,
      "crossDomain": true,
      "url": urlTemplate1,
...
//$("#ProblemsCommitComposition").click(function(){
    var urlCommit1 = openEhrApi.concat('/rest/v1/composition?ehrId=', ehrId, '&templateId=', templateId, '&committerName=', committerName, '&format=FLAT' );
    var settings5 = {
      "async": false,
      "crossDomain": true,
      "url": urlCommit1,
...
//$("#ProblemsReadComposition").click(function(){
    var urlRComp1 = openEhrApi.concat('/rest/v1/composition/', compositionUid, '?format=FLAT');
    var settings6 = {
      "async": false,
      "crossDomain": true,
      "url": urlRComp1,
...
//$("#ProblemsDeleteComposition").click(function(){
      var urlDelete1 = openEhrApi.concat('/rest/v1/composition/', compositionUid);
      var settings7 = {
        "async": false,
        "crossDomain": true,
        "url": urlDelete1,
...
//$("#ProblemsQueryPatientCompositions").click(function(){
    ...
    var aqlquery1 = query1.concat(ehrId, "']  contains COMPOSITION a[openEHR-EHR-COMPOSITION.problem_list.v1]  contains EVALUATION b_a[openEHR-EHR-EVALUATION.problem_diagnosis.v1]  where a/name/value='Problem list'\"\n}");
    var urlQuery1 = openEhrApi.concat('/rest/v1/query');
    var settings8 = {
      "async": false,
      "crossDomain": true,
      "url": urlQuery1,
...
//$("#ProblemsQueryAllCompositions").click(function(){
    ...
    var aqlquery2 = query2.concat(" contains COMPOSITION a[openEHR-EHR-COMPOSITION.problem_list.v1]  contains EVALUATION b_a[openEHR-EHR-EVALUATION.problem_diagnosis.v1]  where a/name/value='Problem list'\"\n}");
    var urlQuery2 = openEhrApi.concat('/rest/v1/query');
    var settings9 = {
      "async": false,
      "crossDomain": true,
      "url": urlQuery2,
...
//$("#AllergiesUploadTemplate").click(function(){
    var urlTemplate2 = openEhrApi.concat('/rest/v1/template/');
    var settings10 = {
      "async": false,
      "crossDomain": true,
      "url": urlTemplate2,
...
//$("#AllergiesCommitComposition").click(function(){
    var urlCommit2 = openEhrApi.concat('/rest/v1/composition?ehrId=', ehrId, '&templateId=', templateId, '&committerName=', committerName, '&format=FLAT' );
    var settings11 = {
      "async": false,
      "crossDomain": true,
      "url": urlCommit2,
...
//$("#AllergiesReadComposition").click(function(){
    var urlRComp2 = openEhrApi.concat('/rest/v1/composition/', compositionUid, '?format=FLAT');
    var settings12 = {
      "async": false,
      "crossDomain": true,
      "url": urlRComp2,
...
//$("#AllergiesDeleteComposition").click(function(){
      var urlDelete2 = openEhrApi.concat('/rest/v1/composition/', compositionUid);
      var settings13 = {
        "async": false,
        "crossDomain": true,
        "url": urlDelete2,
...
//$("#AllergiesQueryPatientCompositions").click(function(){
    ...
    var aqlquery3 = query3.concat(ehrId, "'] contains COMPOSITION a[openEHR-EHR-COMPOSITION.adverse_reaction_list.v1]   contains EVALUATION b_a[openEHR-EHR-EVALUATION.adverse_reaction_risk.v1]  where   a/name/value='Adverse reaction list'\"\n}");
    var urlQuery3 = openEhrApi.concat('/rest/v1/query');
    var settings14 = {
      "async": false,
      "crossDomain": true,
      "url": urlQuery3,
...
//$("#AllergiesQueryAllCompositions").click(function(){
    ...
    var aqlquery4 = query4.concat(" contains COMPOSITION a[openEHR-EHR-COMPOSITION.adverse_reaction_list.v1]   contains EVALUATION b_a[openEHR-EHR-EVALUATION.adverse_reaction_risk.v1]  where   a/name/value='Adverse reaction list'\"\n}");
    var urlQuery4 = openEhrApi.concat('/rest/v1/query');
    var settings15 = {
      "async": false,
      "crossDomain": true,
      "url": urlQuery4,
